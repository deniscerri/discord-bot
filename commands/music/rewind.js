...
module.exports = {
	...
	.setName('rewind')
	.setDescription('Rewind back certain seconds in the song')
...
const forwardSong = async (message) => {
    ...
    let msg = await message.reply({fetchReply: true, content: `⏪ Rewinding back to ${player.convert_length(seek)}`})
